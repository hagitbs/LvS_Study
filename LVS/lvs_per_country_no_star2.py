...
def plot_country_panel(df_country: pd.DataFrame, document: str, out_path: str , entity:str) :
    ...
    ax1.set_xticks(x)
    ax1.set_xticklabels(df_country["element"], rotation=90, ha="right")

    ax1.set_title(
        f"Industry: {entity} — Expected (grey) vs Observed (blue)"
    )
...
# =========================
csv_path = "/Users/hagitbenshoshan/Documents/PHD/Market/Data/vis_cod2.csv"   # <-- set this
out_dir = "/Users/hagitbenshoshan/Documents/PHD/Market/cod_figs_no_star22"
